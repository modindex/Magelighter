...
public class ClericsOvenEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, ITickableTileEntity {
    ...
    protected final IIntArray furnaceData = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return ClericsOvenEntity.this.burnTime;
                case 1:
                    return ClericsOvenEntity.this.recipesUsed;
                case 2:
                    return ClericsOvenEntity.this.cookTime;
                case 3:
                    return ClericsOvenEntity.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    ClericsOvenEntity.this.burnTime = value;
                    break;
                case 1:
                    ClericsOvenEntity.this.recipesUsed = value;
                    break;
                case 2:
                    ClericsOvenEntity.this.cookTime = value;
                    break;
                case 3:
                    ClericsOvenEntity.this.cookTimeTotal = value;
            }
        }
        public int size() {
            return 4;
    ...
    public ClericsOvenEntity() {
        super(ModBlocks.CLERICSOVEN_TILE);
    ...
    private boolean isBurning() { return this.burnTime > 0; }
    ...
    private boolean hasByProduct() {
        if(((ItemStack)this.items.get(0)).isEmpty() || ((ItemStack)this.items.get(3)).isEmpty()) return false;
            ...
            ItemStack result = ByProductRecipes.getInstance().getByProductResult((ItemStack)this.items.get(0), (ItemStack)this.items.get(3));
    ...
    protected void getByProduct() {
        Magelighter.LOGGER.info("Slot 0: " + this.items.get(0));
        Magelighter.LOGGER.info("Slot 3: " + this.items.get(3));
        Magelighter.LOGGER.info("hasByProduct: " + this.hasByProduct());
        if (this.hasByProduct()) {
            ItemStack input1 = (ItemStack) this.items.get(0);
            ItemStack input2 = (ItemStack) this.items.get(3);
            ItemStack result = ByProductRecipes.getInstance().getByProductResult(input1, input2);
    ...
    protected int getBurnTime(ItemStack itemStack) {
        if (itemStack.isEmpty()) {
            ...
            return net.minecraftforge.event.ForgeEventFactory.getItemBurnTime(itemStack, ret == -1 ? getBurnTimes().getOrDefault(item, 0) : ret);
        }
    }
    ...
    public static boolean isFuel(ItemStack itemStack) {
        int ret = itemStack.getBurnTime();
        return net.minecraftforge.event.ForgeEventFactory.getItemBurnTime(itemStack, ret == -1 ? getBurnTimes().getOrDefault(itemStack.getItem(), 0) : ret) > 0;
    }
